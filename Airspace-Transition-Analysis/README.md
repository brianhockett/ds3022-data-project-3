...
&emsp;The only challenges I faced in the analysis step was in working with geographic data. I had never visualized geographic data in python before, so I had to learn how to use the geopandas and cartopy libraries to make my visualizations and conduct my analysis.
